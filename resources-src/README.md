...
- A build process parses directories, bundles code with `esbuild`, copies static assets, generates `fxmanifest.lua`, and emits everything to `../../resources/[trp-framework]/<resource-name>`.
